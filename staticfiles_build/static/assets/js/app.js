(function(window, document, $, undefined) {
    ...
    if (apexChart.length > 0) {
               ...
               var chart = new ApexCharts(
                ...
                if (apexdemo7.length > 0) {
                  var optionDonut = {
                    ...
                    colors: ['#007bff','#2bcbba','#f7b731','#45aaf2','#e3324c'],
        ...
        var analytics7 = jQuery('#analytics7')
            ...
            //             type: 'pie',
            //         },
            //         colors:['#007bff','#fbaf54','#4776E6','#e3324c','#444444'],
                        ...
                        fill: {
                            type: 'gradient',
                                gradient: {
                                  ...
                                  opacityFrom: 1,
                                  opacityTo:1,
                                  gradientToColors: ['#007bff', '#45aaf2' , '#2bcbba'],
                                  stops: [0, 90, 100]
                                }
                          },
                        colors:['#007bff','#45aaf2', '#2bcbba'],
                        series: [45, 55, 80],
                        ...
                        fill: {
                            type: 'gradient',
                                gradient: {
                                  ...
                                  opacityFrom: 1,
                                  opacityTo:0.5,
                                  gradientToColors: ['#007bff', '#4776E6'],
                                  stops: [0, 90, 100]
                                }
                          },
                        colors:['#007bff','#4776E6'],
                        ...
                        function plotAccordingToChoices() {
                            ...
                            if (data.length > 0) {
                                $.plot("#flot-series-toggle", data, {
                                    ...
                                    colors: ["#f7b731", "#fd9644", "#32b432", "#007bff", "#4776E6", "#e3324c", "#fb0792"],
                                    yaxis: {
                                        min: 0
                                    },
                                    xaxis: {
                ...
                function Sparkline() {
                    ...
                    if (sparklinedemo5.length > 0) {
                        $(sparklinedemo5).sparkline([40, 30, 20, 10], {
                            ...
                            width: '200',
                            height: '165',
                            sliceColors: ['#4776E6', '#007bff', '#ffbc1d', '#25d09a']
                        });
                    }
