...
class UpdateDashboardModuleView(SuccessMessageMixin, UpdateView):
    ...
    success_message = ('Widget was successfully updated')
    object = None
    module = None
    ...
    def get_context_data(self, **kwargs):
        ...
        data['child_name'] = self.module.child_name if self.module.child_name else ('Items')
        data['child_name_plural'] = self.module.child_name_plural if self.module.child_name_plural else ('Items')
...
def add_user_dashboard_module_view(request):
    ...
    if form.is_valid():
        module = form.save()
        result['id'] = module.pk
        messages.success(request, ('Widget has been successfully added'))
